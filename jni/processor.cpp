...
static JNINativeMethod gMethodRegistryCameraPreview[] = {
		{ "runfilter", "(Landroid/graphics/Bitmap;[BIII)V", (void *) runfilter },
};
...
JNIEXPORT jint JNI_OnLoad(JavaVM* pVM, void* reserved) {
    ...
    LOGW("JNI_OnLoad\n");
    jclass LiveFeatureActivity = env->FindClass("com/example/LiveFeatureActivity");
    ...
    jclass CameraPreview = env->FindClass("com/example/CameraPreview");
